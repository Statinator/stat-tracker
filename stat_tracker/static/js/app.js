...
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router");router.route("activities",function(){function e(){$(".main-content").html(views.activities),$.ajax({headers:{"X-CSRFToken":r},url:"/api/activities/",method:"GET"}).done(function(e){alert("success"),console.log(e)}).fail(function(e){console.log(e)})}function o(e){var o=null;if(document.cookie&&""!=document.cookie)for(var r=document.cookie.split(";"),t=0;t<r.length;t++){var i=$.trim(r[t]);if(i.substring(0,e.length+1)==e+"="){o=decodeURIComponent(i.substring(e.length+1));break}}return o}e();var r=o("csrftoken");console.log(r)});
