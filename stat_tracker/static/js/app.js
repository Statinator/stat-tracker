...
"use strict";var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router");router.route("activities",function(){function e(){$.ajax({headers:{"X-CSRFToken":o},url:"/api/activities/",method:"GET"}).done(function(e){alert("success"),console.log(e),i({activities:e})}).fail(function(e){console.log(e)})}function t(e){var t=null;if(document.cookie&&""!=document.cookie)for(var i=document.cookie.split(";"),o=0;o<i.length;o++){var r=$.trim(i[o]);if(r.substring(0,e.length+1)==e+"="){t=decodeURIComponent(r.substring(e.length+1));break}}return t}function i(e){var t=_.template(views.activities,{variable:"m"}),i=t(e);$(".main-content").html(i)}e();var o=t("csrftoken");console.log(o)});
